...
def process_account_region(account_id, role_name, account_name, region, services):
    ...
    # Obtener funciones de servicios para esta cuenta/región
...
if __name__ == "__main__":
    ...
    parser.add_argument('--services', nargs='+', default=["ec2", "cloudtrail"],
                      choices=["ec2", "rds", "redshift", "vpc", "subnets", "cloudtrail", "s3", "eks", "ecr", "kms", "lambda", "apigateway", "glue", "cloudformation", "cloudtrail_trails", "ssm", "tax", "stepfunctions", "athena", "transfer", "codepipeline", "emr", "codebuild", "sns", "route53", "cloudfront", "all"],
                      help='Servicios a consultar')
    args = parser.parse_args()
    services = ["ec2", "rds", "redshift", "vpc", "subnets", "s3", "eks", "ecr", "kms", "lambda", "apigateway", "glue", "cloudformation", "cloudtrail_trails", "ssm", "tax", "stepfunctions",  "athena", "transfer", "codepipeline", "emr", "codebuild", "sns", "route53", 'cloudfront'] if "all" in args.services else args.services
    main(services)