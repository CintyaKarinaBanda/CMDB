...
from services.cloudtrail_functions import (
    get_ec2_cloudtrail_events, get_rds_cloudtrail_events, 
    get_vpc_cloudtrail_events, get_subnet_cloudtrail_events,
    get_redshift_cloudtrail_events, insert_or_update_cloudtrail_events
)
